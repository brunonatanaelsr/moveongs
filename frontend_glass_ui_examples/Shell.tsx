...
export function Shell({ title, description, sidebar, children }: PropsWithChildren<ShellProps>) {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 flex min-h-screen flex-col lg:flex-row">
        {sidebar && (
          <aside className="lg:w-80 flex-shrink-0 border-b border-white/10 bg-white/5 backdrop-blur-2xl lg:border-b-0 lg:border-r">
